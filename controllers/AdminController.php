...
use hornetalcala\user\models\Profile;
use hornetalcala\user\models\User;
use hornetalcala\user\models\UserSearch;
...
class AdminController extends Controller
{
    ...
    /**
     * If "hornetalcala/yii2-rbac" extension is installed, this page displays form
    ...
    {
        if (!isset(Yii::$app->extensions['hornetalcala/yii2-rbac'])) {
